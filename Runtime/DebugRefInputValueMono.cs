...
public class DebugRefInputValueMono : MonoBehaviour
{
    ...
    public class DebugInputActionReference_Float
    {
        ...
        public void StartListening()
        {
            ...
            m_whatToObserve.action.canceled += (e) => { m_value = e.ReadValue<float>();
    ...
    public class DebugInputActionReference_Vector2
    {
        ...
        public void StartListening()
        {
            ...
            m_whatToObserve.action.canceled += (e) => { m_value = e.ReadValue<Vector2>();
